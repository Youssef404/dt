                ...
                <div class="block_content">
                    ...
                    <table class="vertical-table">
                        <tr>
                            ...
                            <td>
                                : <?= $student->has('establishment') ? $this->Html->link($student->establishment->name, ['controller' => 'Establishments', 'action' => 'view', $student->establishment->id]) : '' ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                : <?= $student->has('major') ? $this->Html->link($student->major->id, ['controller' => 'Majors', 'action' => 'view', $student->major->id]) : '' ?></td>
                        </tr>
