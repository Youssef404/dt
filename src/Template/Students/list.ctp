                ...
                <div class="left col-xs-7">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fa  fa-university"></i>
                            Etablissement: <?= $student->has('establishment') ? $this->Html->link($student->establishment->name, ['controller' => 'Establishments', 'action' => 'view', $student->establishment->id]) : '' ?>
                        </li>
            ...
            <div class="col-xs-12 bottom text-center">
                <div class="col-xs-12 col-sm-6 emphasis">
                    <button type="button" class="btn btn-primary btn-xs"
                            onclick="window.location.href='<?= $this->Url->build(['controller' => 'students', 'action' => 'view', $student->id]) ?>'">
